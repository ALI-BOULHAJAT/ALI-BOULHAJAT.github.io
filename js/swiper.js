!function(e, t) {
    ...
    var t = {
        ...
        off: function() {
            ...
            for (var o = i.split(" "), l = 0; l < o.length; l += 1) for (var d = o[l], p = 0; p < this.length; p += 1) {
                ...
                u && u.length) for (var h = u.length - 1; 0 <= h; h -= 1) {
                    var v = u[h];
                    r && v.listener === r ? (c.removeEventListener(d, v.proxyListener, n), u.splice(h, 1)) : r || (c.removeEventListener(d, v.proxyListener, n), 
                    u.splice(h, 1));
                }
            }
            return this;
        ...
        offset: function() {
            if (0 < this.length) {
                var e = this[0], t = e.getBoundingClientRect(), a = f.body, i = e.clientTop || a.clientTop || 0, s = e.clientLeft || a.clientLeft || 0, r = e === Y ? Y.scrollY : e.scrollTop, n = e === Y ? Y.scrollX : e.scrollLeft;
                return {
                    top: t.top + r - i,
                    left: t.left + n - s
                };
            ...
            if (void 0 !== i) {
                ...
                for (var E, S = t.slidesPerColumn, C = x / S, M = C - (t.slidesPerColumn * C - d), k = 0; k < d; k += 1) {
                    ...
                    if (1 < t.slidesPerColumn) {
                        ...
                        "column" === t.slidesPerColumnFill ? (L = k - ($ = Math.floor(k / S)) * S, (M < $ || $ === M && L === S - 1) && S <= (L += 1) && (L = 0, 
                        $ += 1), z = $ + L * x / S, P.css({
                    ...
                    if ("none" !== P.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            var I = Y.getComputedStyle(P[0], null), D = P[0].style.transform, O = P[0].style.webkitTransform;
                            D && (P[0].style.transform = "none"), O && (P[0].style.webkitTransform = "none"), 
                        ...
                        l[k] && (l[k].swiperSlideSize = T), u.push(T), t.centeredSlides ? (b = b + T / 2 + w / 2 + g, 
                        0 === w && 0 !== k && (b = b - i / 2 - g), 0 === k && (b = b - i / 2 - g), Math.abs(b) < .001 && (b = 0), 
    ...
    var d = {
        ...
        setTranslate: function(e, t) {
            ...
            l = Math.floor(l)), s.virtualTranslate || (F.transforms3d ? r.transform("translate3d(" + o + "px, " + l + "px, 0px)") : r.transform("translate(" + o + "px, " + l + "px)")), 
    ...
    var c = {
        slideTo: function(e, t, a, i) {
            ...
            "reset" !== h && (s.transitionStart(a, h), s.transitionEnd(a, h)), !1) : (0 !== t && F.transition ? (s.setTransition(t), 
    ...
    var b = {
        attachEvents: function() {
            ...
            e.onTouchStart = function(e) {
                    ...
                    (a.isTouchEvent || !("which" in r) || 3 !== r.which) && !(!a.isTouchEvent && "button" in r && 0 < r.button || a.isTouched && a.isMoved)) if (i.noSwiping && L(r.target).closest(i.noSwipingSelector ? i.noSwipingSelector : "." + i.noSwipingClass)[0]) t.allowClick = !0; else if (!i.swipeHandler || L(r).closest(i.swipeHandler)[0]) {
                        ...
                        if (!l || !(n <= d || n >= Y.screen.width - d)) {
                            if (V.extend(a, {
                                ...
                                isScrolling: void 0,
                                startMoving: void 0
                            }), s.startX = n, s.startY = o, a.touchStartTime = V.now(), t.allowClick = !0, t.updateSize(), 
                            t.swipeDirection = void 0, 0 < i.threshold && (a.allowThresholdMove = !1), "touchstart" !== r.type) {
                                var p = !0;
                ...
                t.emit("doubleTap", d))), a.lastClickTime = V.now(), V.nextTick(function() {
                ...
                i.freeMode) {
                    ...
                    for (var M = 0, k = t.slidesSizesGrid[0], P = 0; P < o.length; P += i.slidesPerGroup) void 0 !== o[P + i.slidesPerGroup] ? p >= o[P] && p < o[P + i.slidesPerGroup] && (k = o[(M = P) + i.slidesPerGroup] - o[P]) : p >= o[P] && (M = P, 
        ...
        setBreakpoint: function() {
            ...
            if (r && (!r || 0 !== Object.keys(r).length)) {
                ...
                if (n && e.currentBreakpoint !== n) {
                    ...
                    }), e.currentBreakpoint = n, d && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), 
    ...
    var x = {
        ...
        classes: {
            addClasses: function() {
                ...
                s.push(a.direction), a.freeMode && s.push("free-mode"), F.flexbox || s.push("no-flexbox"), 
                a.autoHeight && s.push("autoheight"), e && s.push("rtl"), 1 < a.slidesPerColumn && s.push("multirow"), 
                m.android && s.push("android"), m.ios && s.push("ios"), (I.isIE || I.isEdge) && (F.pointerEvents || F.prefixedPointerEvents) && s.push("wp8-" + a.direction), 
        ...
        images: {
            loadImage: function(e, t, a, i, s, r) {
                ...
                e.complete && s ? o() : t ? ((n = new Y.Image()).onload = o, n.onerror = o, i && (n.sizes = i), 
        ...
        function h() {
            ...
            s = e[1]), s || (s = {}), s = V.extend({}, s), t && !s.el && (s.el = t), u.call(this, s), 
            ...
            var n = V.extend({}, x);
            r.useModulesParams(n), r.params = V.extend({}, n, E, s), r.originalParams = V.extend({}, r.params), 
        ...
        update: function(e) {
            ...
            for (var k = 0; k < u.length; k += 1) y <= k && k <= x && (void 0 === c || e ? C.push(k) : (c < k && C.push(k), 
            k < p && S.push(k)));
    ...
    var H = {
        ...
        handle: function(e) {
            ...
            if (i.invert && (s = -s), a.params.freeMode) {
                ...
                a.params.freeModeSticky && (clearTimeout(a.mousewheel.timeout), a.mousewheel.timeout = V.nextTick(function() {
                    a.slideToClosest();
        ...
        setTranslate: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                ...
                p = 0) : r < p + s && (d = r - p), e.isHorizontal() ? (F.transforms3d ? n.transform("translate3d(" + p + "px, 0, 0)") : n.transform("translateX(" + p + "px)"), 
        ...
        updateSize: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                ...
                e.params.scrollbarHide && (i[0].style.opacity = 0), V.extend(t, {
                    trackSize: r,
                    divider: n,
                    moveDivider: o,
                    dragSize: s
        ...
        enableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                var t = e.scrollbar, a = e.touchEventsTouch, i = e.touchEventsDesktop, s = e.params, r = t.$el[0], n = !(!F.passiveListener || !s.passiveListeners) && {
                    passive: !1,
                    capture: !1
                ...
                F.touch ? (r.addEventListener(a.start, e.scrollbar.onDragStart, n), r.addEventListener(a.move, e.scrollbar.onDragMove, n), 
        ...
        disableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                F.touch ? (r.removeEventListener(a.start, e.scrollbar.onDragStart, n), r.removeEventListener(a.move, e.scrollbar.onDragMove, n), 
        ...
        onTouchMove: function(e) {
            ...
            if (i.$imageEl && 0 !== i.$imageEl.length && (t.allowClick = !1, s.isTouched && i.$slideEl)) {
                ...
                s.startX = V.getTranslate(i.$imageWrapEl[0], "x") || 0, s.startY = V.getTranslate(i.$imageWrapEl[0], "y") || 0, 
        ...
        init: function() {
            ...
            if (e.params.history) {
                ...
                var t = e.history;
                t.initialized = !0, t.paths = K.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), 

    ...
    return function() {
            ...
            !function(b, e) {
                ...
                return function(a) {
                    ...
                    (function(a) {
                        ...
                        function h() {
                            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = new u(), c = b.tween(a);
                        ...
                        var i = c(1), j = "undefined" != typeof window ? window : a, k = j.requestAnimationFrame || j.webkitRequestAnimationFrame || j.oRequestAnimationFrame || j.msRequestAnimationFrame || j.mozCancelRequestAnimationFrame && j.mozRequestAnimationFrame || setTimeout, l = function() {}, m = null, n = null, o = f({}, i), p = function(a, b, c, d, e, f, g) {
                            var h = a < f ? 0 : (a - f) / e;
                            for (var i in b) {
                            ...
                            m >= l ? (i(j, c, n), a.stop(!0)) : (a._applyFilter("beforeTween"), m < k + e ? (m = 1, 
                            h = 1, k = 1) : k += e, p(m, d, g, j, h, k, f), a._applyFilter("afterTween"), i(d, c, n));
                        }, r = function() {
                            ...
                            function a() {
                                ...
                                }(this, a), this._currentState = b, this._configured = !1, this._filters = [], this._timestamp = null, 
                                this._next = null, this._previous = null, c && this.setConfig(c);
                            }
                            var b, c, e;
                            return b = a, (c = [ {
                                key: "_applyFilter",
                                ...
                                value: function() {
                                    ...
                                    return !b && d || this.setConfig(b), this._pausedAtTime = null, this._timestamp = a.now(), 
                                    this._start(this.get(), c), this.resume();
                                }
                            }, {
                                key: "setConfig",
                                value: function() {
                                    var b = this, c = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, d = c.attachment, e = c.delay, g = void 0 === e ? 0 : e, h = c.duration, i = void 0 === h ? 500 : h, j = c.easing, k = c.from, m = c.promise, n = void 0 === m ? Promise : m, o = c.start, p = void 0 === o ? l : o, q = c.step, r = void 0 === q ? l : q, t = c.to;
                                    this._configured = !0, this._attachment = d, this._isPlaying = !1, this._pausedAtTime = null, 
                                    this._scheduleId = null, this._delay = g, this._start = p, this._step = r, this._duration = i, 
                                    this._currentState = f({}, k || this.get()), this._originalState = this.get(), this._targetState = f({}, t || this.get());
                                ...
                                key: "pause",
                                value: function() {
                                    if (this._isPlaying) return this._pausedAtTime = a.now(), this._isPlaying = !1, 
                                    t(this), this;
                                }
                            }, {
                                key: "resume",
                                value: function() {
                                    ...
                                    this._isPlaying = !0, null === m ? (m = this, n = this, function a() {
                                ...
                                value: function(b) {
                                    b = Math.max(b, 0);
                                    var c = a.now();
                                    return this._timestamp + b === 0 ? this : (this._timestamp = c - b, this._isPlaying || q(this, c), 
                                    this);
                                }
                            }, {
                                key: "stop",
                                value: function() {
                                    ...
                                    if (this._isPlaying) return this._isPlaying = !1, t(this), a ? (this._applyFilter("beforeTween"), 
                                    p(1, c, e, f, 1, 0, d), this._applyFilter("afterTween"), this._applyFilter("afterTweenEnd"), 
                                    this._resolve(c, b)) : this._reject(c, b), this;
                                }
                            }, {
                                key: "isPlaying",
                                value: function() {
                    ...
                    var n, o, p = c(0), q = /(\d|-|\.)/, r = /([^\-0-9.]+)/g, s = /[0-9.-]+/g, t = (n = s.source, 
                    o = /,\s*/.source, new RegExp("rgb\\(".concat(n).concat(o).concat(n).concat(o).concat(n, "\\)"), "g")), u = /^.*\(/, v = /#([0-9]|[a-f]){3,6}/gi, w = function(a, b) {
                        ...
                        for (var e in a) {
                            var f = a[e];
                            "string" == typeof f && (d[e] = {
                                formatString: (b = f, c = void 0, c = b.match(r), c ? (1 === c.length || b.charAt(0).match(q)) && c.unshift("") : c = [ "", "" ], 
                                c.join("VAL")),
                                chunkNames: w(B(f), e)
                            });
                        }
                        ...
                        for (var i in L._filters.length = 0, L.set({}), L._currentState = f, L._originalState = a, 
                        L._targetState = b, L._easing = g, M) M[i].doesApply(L) && L._filters.push(M[i]);
        ...
        5: [ function(a, b, c) {
            var d = a("shifty"), e = a("./utils"), f = d.Tweenable, g = {
                ...
                var d;
                d = e.isString(b) ? document.querySelector(b) : b, this.path = d, this._opts = c, 
        ...
        6: [ function(a, b, c) {
            ...
            }, g.prototype._pathString = e.prototype._pathString, g.prototype._trailString = e.prototype._trailString, 
            b.exports = g;
        }, {
            "./circle": 2,
            "./shape": 7,
        ...
        7: [ function(a, b, c) {
            var d = a("./path"), e = a("./utils"), f = "Object is destroyed", g = function a(b, c) {
                ...
                if (0 !== arguments.length) {
                    this._opts = e.extend({
                        ...
                        warnings: !1
                    }, c, !0), e.isObject(c) && void 0 !== c.svgStyle && (this._opts.svgStyle = c.svgStyle), 
                    ...
                    this._container = f, this._container.appendChild(g.svg), this._opts.warnings && this._warnContainerAspectRatio(this._container), 
                    this._opts.svgStyle && e.setStyles(g.svg, this._opts.svgStyle), this.svg = g.svg, 
                    this.path = g.path, this.trail = g.trail, this.text = null;
                    var h = e.extend({
                        attachment: void 0,
                        shape: this
                    }, this._opts);
            ...
            g.prototype.animate = function(a, b, c) {
                ...
                this.trail = null, this._progressPath = null, null !== this.text && (this.text.parentNode.removeChild(this.text), 
                this.text = null);
                ...
                this._container.appendChild(this.text)), e.isObject(a) ? (e.removeChildren(this.text), 
                ...
                return c.trailColor || (c.trailColor = "#eee"), c.trailWidth || (c.trailWidth = c.strokeWidth), 
                c.color = c.trailColor, c.strokeWidth = c.trailWidth, c.fill = null, this._createPathElement(b, c);
            }, g.prototype._createPathElement = function(a, b) {
                var c = document.createElementNS("http://www.w3.org/2000/svg", "path");
                return c.setAttribute("d", a), c.setAttribute("stroke", b.color), c.setAttribute("stroke-width", b.strokeWidth), 
                b.fill ? c.setAttribute("fill", b.fill) : c.setAttribute("fill-opacity", "0"), c;
            }, g.prototype._createTextContainer = function(a, b) {
                var c = document.createElement("div");
                c.className = a.text.className;
                var d = a.text.style;
                return d && (a.text.autoStyleContainer && (b.style.position = "relative"), e.setStyles(c, d), 
                d.color || (c.style.color = a.color)), this._initializeTextContainer(a, b, c), c;

!function(n, e) {
    ...
    function c(n, e) {
        var r = s(n), i = a(u.und(r[0]) ? 1 : r[0], .1, 100), o = a(u.und(r[1]) ? 100 : r[1], .1, 100), c = a(u.und(r[2]) ? 10 : r[2], .1, 100), f = a(u.und(r[3]) ? 0 : r[3], .1, 100), l = Math.sqrt(o / i), d = c / (2 * Math.sqrt(o * i)), p = d < 1 ? l * Math.sqrt(1 - d * d) : 0, v = 1, h = d < 1 ? (d * l - f) / p : -f + l;
        function g(n) {
            var r = e ? e * n / 1e3 : n;
    ...
    var d = function() {
        ...
        return function(r, t, a, u) {
            if (0 <= r && r <= 1 && 0 <= a && a <= 1) {
                ...
                if (r !== t || a !== u) for (var c = 0; c < n; ++c) s[c] = i(c * e, r, a);
                return function(n) {
            ...
            function f(t) {
                ...
                var l = u + (t - s[--c]) / (s[c + 1] - s[c]) * e, d = o(l, r, a);
    ...
    function g(n, e) {
        for (var r = n.length, t = arguments.length >= 2 ? arguments[1] : void 0, a = [], i = 0; i < r; i++) if (i in n) {
            var o = n[i];
    ...
    function k(n) {
        return u.rgb(n) ? (r = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e = n)) ? "rgba(" + r[1] + ",1)" : e : u.hex(n) ? (t = n.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(n, e, r, t) {
            ...
            if (0 == o) e = r = t = u; else {
                var f = u < .5 ? u * (1 + o) : u + o - u * o, l = 2 * u - f;
    ...
    function I(n, e, r) {
        ...
        var a = t.CSS[e + r];
        if (!u.und(a)) return a;
        var i = document.createElement(n.tagName), o = n.parentNode && n.parentNode !== document ? n.parentNode : document.body;
    ...
    function A(n, e) {
        var r = /^(\*=|\+=|-=)/.exec(n);
        if (!r) return n;
        var t = C(n) || 0, a = parseFloat(e), i = parseFloat(n.replace(r[0], ""));
        switch (r[0][0]) {
          case "+":
            return a + i + t;
    ...
    function q(n, e) {
        var r = e || {}, t = r.el || function(n) {
            ...
            return e;
        }(n), a = t.getBoundingClientRect(), i = P(t, "viewBox"), o = a.width, s = a.height, c = r.viewBox || (i ? i.split(" ") : [ 0, 0, o, s ]);
        return {
            el: t,
            viewBox: c,
            x: c[0] / 1,
    ...
    function $(n, e) {
        ...
        var t = q(n.el, n.svg), a = r(), i = r(-1), o = r(1);
        switch (n.property) {
          case "x":
            return (a.x - t.x) * t.w;
    ...
    function Q(n, e) {
        ...
        return a.map(function(n, r) {
            ...
            return u.und(t.delay) && (t.delay = r ? 0 : e.delay), u.und(t.endDelay) && (t.endDelay = r === a.length - 1 ? e.endDelay : 0), 
            t;
        }).map(function(n) {
            return w(n, r);
        });
    ...
    function z(n, e) {
        ...
        return n.tweens.map(function(t) {
            ...
            }(t, e), i = a.value, o = u.arr(i) ? i[1] : i, s = C(o), c = N(e.target, n.name, s, e), f = r ? r.to.original : c, l = u.arr(i) ? i[0] : f, d = C(l) || C(c), p = s || d;
            return u.und(o) && (o = f), a.from = X(l, p), a.to = X(A(o, l), p), a.start = r ? r.end : 0, 
            a.end = a.start + a.delay + a.duration + a.endDelay, a.easing = v(a.easing, a.duration), 
            a.isPath = u.pth(i), a.isColor = u.col(a.from.original), a.isColor && (a.round = 1), 
            r = a, a;
        });
    }
    var H = {
    ...
    function G(n, e) {
        Z(n).forEach(function(n) {
            for (var r in e) {
                var t = O(e[r], n), a = n.target, i = C(t), o = N(a, r, i, n), u = A(E(t, i || C(o)), o), s = D(a, r);
    ...
    function en(r) {
        ...
        var l, d, p, v, h, m, y, b, x = f(), k = (d = M(n, l = r), p = M(e, l), v = V(p, l), 
        h = Z(l.targets), m = R(h, v), y = W(m, p), b = J, J++, w(d, {
            id: b,
            children: [],
            animatables: h,
            animations: m,
        ...
        function B(n) {
            for (var e = 0, r = k.animations, t = r.length; e < t; ) {
                var i = r[e], o = i.animatable, u = i.tweens, s = u.length - 1, c = u[s];
                s && (c = g(u, function(e) {
                    return n < e.end;
                })[0] || c);
                for (var f = a(n - c.start - c.delay, 0, c.duration) / c.duration, l = isNaN(f) ? 1 : c.easing(f), d = c.to.strings, p = c.round, v = [], h = c.to.numbers.length, m = void 0, y = 0; y < h; y++) {
                    var b = void 0, x = c.to.numbers[y], M = c.from.numbers[y] || 0;
                    b = c.isPath ? $(c.value, l * x) : M + l * (x - M), p && (c.isColor && y > 2 || (b = Math.round(b * p) / p)), 
                    v.push(b);
                }
                var w = d.length;
                if (w) {
        ...
        function T(n) {
            var e = k.duration, r = k.delay, l = e - k.endDelay, d = O(n);
            k.progress = a(d / e * 100, 0, 100), k.reversePlayback = d < k.currentTime, t && function(n) {
                if (k.reversePlayback) for (var e = s; e--; ) I(n, t[e]); else for (var r = 0; r < s; r++) I(n, t[r]);
            }(d), !k.began && k.currentTime > 0 && (k.began = !0, D("begin"), D("loopBegin")), 
            d <= r && 0 !== k.currentTime && B(0), (d >= l && k.currentTime !== e || !e) && B(e), 
            d > r && d < l ? (k.changeBegan || (k.changeBegan = !0, k.changeCompleted = !1, 
            D("changeBegin")), D("change"), B(d)) : k.changeBegan && (k.changeCompleted = !0, 
            k.changeBegan = !1, D("changeComplete")), k.currentTime = a(d, 0, e), k.began && D("update"), 
            n >= e && (o = 0, k.remaining && !0 !== k.remaining && k.remaining--, k.remaining ? (i = u, 
            D("loopComplete"), D("loopBegin"), "alternate" === k.direction && C()) : (k.paused = !0, 
            k.completed || (k.completed = !0, D("loopComplete"), D("complete"), "Promise" in window && (c(), 
            x = f()))));
        }
        return k.reset = function() {
            var n = k.direction;
            k.passThrough = !1, k.currentTime = 0, k.progress = 0, k.paused = !0, k.began = !1, 
            k.changeBegan = !1, k.completed = !1, k.changeCompleted = !1, k.reversePlayback = !1, 
            k.reversed = "reverse" === n, k.remaining = k.loop, t = k.children;
    ...
    return document.addEventListener("visibilitychange", function() {
        ...
        for (var e = Y(n), r = U.length; r--; ) {
            var t = U[r], a = t.animations, i = t.children;
            rn(e, a);
            for (var o = i.length; o--; ) {
                var u = i[o], s = u.animations;
        ...
        void 0 === e && (e = {});
        var r = e.direction || "normal", t = e.easing ? v(e.easing) : null, a = e.grid, i = e.axis, o = e.from || 0, s = "first" === o, c = "center" === o, f = "last" === o, l = u.arr(n), d = l ? parseFloat(n[0]) : parseFloat(n), p = l ? parseFloat(n[1]) : 0, h = C(l ? n[1] : n) || 0, g = e.start || 0 + (l ? d : 0), m = [], y = 0;
        return function(n, e, u) {
            if (s && (o = 0), c && (o = (u - 1) / 2), f && (o = u - 1), !m.length) {
                for (var v = 0; v < u; v++) {
                    if (a) {
                        var b = c ? (a[0] - 1) / 2 : o % a[0], x = c ? (a[1] - 1) / 2 : Math.floor(o / a[0]), M = b - v % a[0], w = x - Math.floor(v / a[0]), k = Math.sqrt(M * M + w * w);
        ...
        return r.duration = 0, r.add = function(t, a) {
            var i = U.indexOf(r), o = r.children;
            function s(n) {
                n.passThrough = !0;
            }
            i > -1 && U.splice(i, 1);
            ...
            var l = r.duration;
            f.autoplay = !1, f.direction = r.direction, f.timelineOffset = u.und(a) ? l : A(a, l), 
            s(r), r.seek(f.timelineOffset);
            var d = en(f);
            s(d), o.push(d);
            var p = W(o, n);

!function(t, e) {
    ...
    return function(t) {
        ...
        var r = function(t, e) {
        ...
        }, s = o(1), c = "object" == typeof self && self && self.Object === Object && self, l = s.a || c || Function("return this")(), a = l.Symbol, u = Object.prototype, h = u.hasOwnProperty, f = u.toString, p = a ? a.toStringTag : void 0, d = Object.prototype.toString, v = a ? a.toStringTag : void 0, y = function(t) {
            return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : v && v in Object(t) ? function(t) {
                var e = h.call(t, p), o = t[p];
                try {
                    t[p] = void 0;
                    var r = !0;
                } catch (t) {}
        ...
        }, _ = /^\s+|\s+$/g, b = /^[-+]0x[0-9a-f]+$/i, m = /^0b[01]+$/i, x = /^0o[0-7]+$/i, g = parseInt, O = function(t) {
            ...
            return void 0 === o && (o = e, e = void 0), void 0 !== o && (o = (o = O(o)) == o ? o : 0), 
            void 0 !== e && (e = (e = O(e)) == e ? e : 0), function(t, e, o) {
                return t == t && (void 0 !== o && (t = t <= o ? t : o), void 0 !== e && (t = t >= e ? t : e)), 
                t;
            }(O(t), e, o);
        }, j = function() {
            return l.Date.now();
        }, S = Math.max, M = Math.min, k = function(t, e, o) {
            var r, n, s, c, l, a, u = 0, h = !1, f = !1, p = !0;
            ...
            return e = O(e) || 0, i(o) && (h = !!o.leading, s = (f = "maxWait" in o) ? S(O(o.maxWait) || 0, e) : s, 
            p = "trailing" in o ? !!o.trailing : p), b.cancel = function() {
                void 0 !== l && clearTimeout(l), u = 0, r = a = n = l = void 0;
            }, b.flush = function() {
                return void 0 === l ? c : _(j());
            }, b;
        }, P = o(0), T = [ "webkit", "moz", "ms", "o" ], E = new RegExp("^-(?!(?:" + T.join("|") + ")-)");
        function W(t, e) {
            e = function(t) {
                var e = {};
        ...
        var A, C = function() {
            ...
            return t.prototype.render = function(t) {
                var e = t.x, o = void 0 === e ? 0 : e, r = t.y, n = void 0 === r ? 0 : r, i = this._scrollbar, s = i.size, c = i.track, l = i.offset;
                if (W(i.contentEl, {
                ...
                n && (c.yAxis.show(), a = s.container.height / (s.container.height + Math.abs(n)), 
                W(c.yAxis.thumb.element, {
            ...
            function t(t) {
                this._scrollbar = t, this._canvas = document.createElement("canvas"), this._ctx = this._canvas.getContext("2d"), 
                W(this._canvas, {
                    position: "absolute",
                    top: 0,
                    left: 0,
            ...
            return t.prototype.mount = function() {
                ...
                var t = this._scrollbar.size, e = window.devicePixelRatio || 1, o = t.container.width * e, r = t.container.height * e;
                o === this._canvas.width && r === this._canvas.height || (this._canvas.width = o, 
                this._canvas.height = r, this._ctx.scale(e, e));
            }, t.prototype.recordTouch = function(t) {
                var e = t.touches[t.touches.length - 1];
                this._touchX = e.clientX, this._touchY = e.clientY;
            }, t.prototype.render = function(t, e) {
                var o = t.x, r = void 0 === o ? 0 : o, n = t.y, i = void 0 === n ? 0 : n;
                if (r || i) {
                    W(this._canvas, {
                        display: "block"
                    });
                    var s = this._scrollbar.size;
                    this._ctx.clearRect(0, 0, s.container.width, s.container.height), this._ctx.fillStyle = e, 
                    this._renderX(r), this._renderY(i);
                } else W(this._canvas, {
                    display: "none"
                });
                ...
                var e = this._scrollbar.size, o = this._getMaxOverscroll(), r = e.container, n = r.width, i = r.height, s = this._ctx;
                s.save(), t > 0 && s.transform(-1, 0, 0, 1, n, 0);
                var c = w(Math.abs(t) / o, 0, .75), l = w(c, 0, .25) * n, a = Math.abs(t), u = this._touchY || i / 2;
                s.globalAlpha = c, s.beginPath(), s.moveTo(0, -l), s.quadraticCurveTo(a, u, 0, i + l), 
                s.fill(), s.closePath(), s.restore();
            }, t.prototype._renderY = function(t) {
                var e = this._scrollbar.size, o = this._getMaxOverscroll(), r = e.container, n = r.width, i = r.height, s = this._ctx;
                s.save(), t > 0 && s.transform(1, 0, 0, -1, 0, i);
                var c = w(Math.abs(t) / o, 0, .75), l = w(c, 0, .25) * n, a = this._touchX || n / 2, u = Math.abs(t);
                s.globalAlpha = c, s.beginPath(), s.moveTo(-l, 0), s.quadraticCurveTo(a, u, n + l, 0), 
                s.fill(), s.closePath(), s.restore();
            }, t;
        }();
        ...
        var B = /wheel|touch/, z = function(t) {
            function e() {
            ...
            return function(t, e) {
                ...
                var t = this._glow, e = this.options, o = this.scrollbar, r = e.effect;
                ...
                if (this._enabled) {
                    ...
                    this.scrollbar.setMomentum(e, o), this._render();
                }
            }, e.prototype.transformDelta = function(t, e) {
                if (this._lastEventType = e.type, !this._enabled || !B.test(e.type)) return t;
                this._isWheelLocked && /wheel/.test(e.type) && (this._releaseWheel(), this._willOverscroll("x", t.x) && (t.x = 0), 
                this._willOverscroll("y", t.y) && (t.y = 0));
                var o = t.x, r = t.y;
                switch (this._willOverscroll("x", t.x) && (o = 0, this._addAmplitude("x", t.x)), 
                this._willOverscroll("y", t.y) && (r = 0, this._addAmplitude("y", t.y)), e.type) {
                  case "touchstart":
                  case "touchmove":
                ...
                var o = this.scrollbar.offset[t], r = this.scrollbar.limit[t];
                return 0 !== r && w(o + e, 0, r) === o && (0 === o || o === r);
            }, e.prototype._absorbMomentum = function(t, e) {
                var o = this.options, r = this._lastEventType, n = this._amplitude;
                B.test(r) && (n[t] = w(e, -o.maxOverscroll, o.maxOverscroll));
            }, e.prototype._addAmplitude = function(t, e) {
                var o = this.options, r = this.scrollbar, n = this._amplitude, i = this._position, s = n[t], c = e * s < 0, l = s + e * (1 - (c ? 0 : this._wheelScrollBack[t] ? 1 : Math.abs(s / o.maxOverscroll)));
                n[t] = 0 === r.offset[t] ? w(l, -o.maxOverscroll, 0) : w(l, 0, o.maxOverscroll), 
                c && (i[t] = n[t]);
            }, e.prototype._render = function() {
                var t = this.options, e = this._amplitude, o = this._position;
                if (this._enabled && (e.x || e.y || o.x || o.y)) {
                    var r = this._nextAmp("x"), i = this._nextAmp("y");
                    switch (e.x = r.amplitude, o.x = r.position, e.y = i.amplitude, o.y = i.position, 
                    t.effect) {
                      case A.BOUNCE:
                ...
                var e = this.options, o = this._amplitude, r = this._position, n = 1 - e.damping, i = o[t], s = r[t], c = this._touching ? i : i * n | 0, l = c - s, a = s + l - (l * n | 0);
                return !this._touching && Math.abs(a) < Math.abs(s) && (this._wheelScrollBack[t] = !0), 
                this._wheelScrollBack[t] && Math.abs(a) <= 1 && (this._wheelScrollBack[t] = !1, 
                this._lockWheel[t] = !0), {
                    amplitude: c,
                    position: a
                };
